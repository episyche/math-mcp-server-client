...
DEFAULT_CAPABILITIES: Dict[str, List[ToolSchema]] = {
    ...
    "telegram": [
        ToolSchema("authenticate_with_code", parameters={"code": "string"}),
        ToolSchema("authenticate_with_password", parameters={"password": "string"}),
        ToolSchema("get_my_info", parameters={}),
        ToolSchema("search_contacts", parameters={"query": "string", "limit": "integer"}),
        ToolSchema("list_chats", parameters={"limit": "integer", "chat_type": "string"}),
        ToolSchema("get_chat_history", parameters={"chat_id": "integer", "limit": "integer"}),
        ToolSchema("send_message", parameters={"recipient": "string", "message": "string"}),
        ToolSchema("search_messages", parameters={"query": "string", "chat_id": "integer", "limit": "integer"}),
        ToolSchema("get_chat_info", parameters={"chat_id": "integer"}),
        ToolSchema("export_chat_history", parameters={"chat_id": "integer", "limit": "integer", "format": "string"}),
    ],
}
